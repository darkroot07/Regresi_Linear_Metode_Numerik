...
main(){
	...
	printf("\nSigma X Kuadrat adalah  : %.0f",SigmaXkuadrat);
	printf("\nSigma Y Kuadrat adalah  : %.0f",SigmaYkuadrat);
	...
	printf("\nSigma dari XY adalah  : %.0f",SigmaXkaliY);
	printf("\n===============================");
	// mencari m
	...
	printf("\nSigma dari y aksen adalah  : %.3f",SigmaYaksen);
	printf("\n===============================");
	...
	printf("\nSigma dari Eror adalah  : %.3f",SigmaEror);
	printf("\n===============================");
	
	rata = SigmaEror / n;
	printf("\nNilai error rata-rata adalah  : %.3f",rata);
	printf("\n===============================");
	printf("\nMelakukan Prediksi");
	//Melakukan Prediksi
	int jarak;
	float waktu,waktu1,waktu2;
	printf("\nInput jarak yang di inginkan : ");
	scanf("%d",&jarak);
	waktu=m*jarak+c;
	waktu1=waktu-rata;
	waktu2=waktu+rata;
	printf("\nWaktu prediksi sebelum tambah eror  : %.3f",waktu);
	printf("\n%.3f%",waktu1);
	printf(" < waktu < ");
	printf("%.3f%",waktu2);
